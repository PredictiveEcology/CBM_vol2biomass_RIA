...
Require(c("reproducible", "quickPlot", "SpaDES", "reproducible",
          "SpaDES.core (>=1.1.0)", "SpaDES.tools (>= 1.0.0)",
          "googledrive", "PredictiveEcology/CBMutils@development",
          "data.table", "devtools", "lme4"), # comes up with an error so added "devtools'
